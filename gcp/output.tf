...
output "enable_artifact_repo_admin_role" {
  value = "gcloud projects add-iam-policy-binding ${var.project_id} --member=user:<your-email> --role=roles/artifactregistry.admin"
}
